        ...
        <div id="wrapper">
            ...
            <main>
                ...
                <p>Our records show you submitted the following:<br>
                  First Name: <?php echo htmlspecialchars($myFirstName, ENT_QUOTES, 'UTF-8'); ?><br>
                  Last Name: <?php echo htmlspecialchars($myLastName, ENT_QUOTES, 'UTF-8'); ?><br>
                  Email: <?php echo htmlspecialchars($myEmail, ENT_QUOTES, 'UTF-8'); ?><br>
				  Course: <?php echo htmlspecialchars($myCourse, ENT_QUOTES, 'UTF-8'); ?><br>
